...
import './style/TransactionLanding.scss'

export default class TransactionLanding extends Component {
    constructor(props) {
      super(props);
      this.state = {
        transactionList: [],
  ...
  render = () => {
        ...
        return (
          <main className="container">
            <h2 className="text-black my-4">Vertcoin Transactions</h2>
            <Form>
            ...
            <h3 className="text-black my-4">Unmined Transactions</h3>
